...
def mixed_nishita(
    ...
    mix_rgb = nw.new_node(Nodes.MixRGB, input_kwargs={"A": sky_texture, "B": rgb})

    return nw.new_node(
        Nodes.Background, input_kwargs={"Color": mix_rgb, "Strength": strength}
    )
