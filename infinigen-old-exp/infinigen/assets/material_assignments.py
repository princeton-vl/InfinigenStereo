...
def kitchen_sink_materials():
    ...
    return {
        "sink": TextureAssignments(sink_shaders, [1.0] * len(sink_shaders)),
        "tap": TextureAssignments(tap_shaders, [1.0] * len(tap_shaders)),
        "wear_tear": [procedural_scratch, procedural_edge_wear],
        "wear_tear_prob": [DEFAULT_SCRATCH_PROB, DEFAULT_EDGE_WEAR_PROB],
    }
...
def window_materials():
    ...
    # curtain_shaders = plastic_shaders + wood_shaders
