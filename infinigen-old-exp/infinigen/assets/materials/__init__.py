...
from .dark_glass import shader_dark_glass
from .fabrics import (
    coarse_knit_fabric,
    fine_knit_fabric,
    general_fabric,
...
from .glass import shader_glass, shader_oneway_glass
from .metal import (
    brushed_metal,
    galvanized_metal,
...
from .tiles import advanced_tiles
from .woods import (
    composite_wood_tile,
    crossed_wood_tile,
    hexagon_wood_tile,
...
glass_shader_list = [shader_glass]  # shader_wood, shader_oneway_glass
