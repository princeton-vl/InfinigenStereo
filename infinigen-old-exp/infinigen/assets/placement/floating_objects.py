...
def add_ico():
    ...
    wireframe_modifier = asset.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.05, 0.1)
    wireframe_modifier.thickness = random_thickness
...
def add_cube():
    ...
    subdivision_modifier = cube.modifiers.new(name="Subdivision", type="SUBSURF")
    subdiv_lev = np.random.randint(1, 4)
    subdivision_modifier.levels = subdiv_lev
    subdivision_modifier.render_levels = subdiv_lev
    ...
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
    bpy.context.view_layer.update()
...
def add_plane():
    ...
    subdivision_modifier = plane.modifiers.new(name="Subdivision", type="SUBSURF")
    subdiv_lev = np.random.randint(1, 5)
    subdivision_modifier.levels = subdiv_lev
    subdivision_modifier.render_levels = subdiv_lev
    subdivision_modifier.subdivision_type = "SIMPLE"
    bpy.context.view_layer.objects.active = plane
    bpy.ops.object.modifier_apply(modifier="Subdivision")
    wireframe_modifier = plane.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
...
def add_cone():
    ...
    wireframe_modifier = cone.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
...
def add_torus():
    ...
    wireframe_modifier = torus.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
...
def add_sphere():
    ...
    wireframe_modifier = sphere.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
...
def add_cylinder():
    ...
    wireframe_modifier = cylinder.modifiers.new(name="Wireframe", type="WIREFRAME")
    random_thickness = np.random.uniform(0.04, 0.07)
    wireframe_modifier.thickness = random_thickness
    wireframe_modifier.use_even_offset = True
    wireframe_modifier.use_replace = True
...
class FloatingObjectPlacement:
    ...
    def place_objs(
        ...
        for i in range(num_place):
            ...
            # ico_funs = [add_cylinder, add_sphere, add_cone, add_cube, add_ico, add_plane, add_torus]
            # fac = np.random.choice(funs)
            # asset = fac()
