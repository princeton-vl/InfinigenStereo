...
room_floor_fns = defaultdict(
    lambda: ("weighted_choice", (2, "non_wood_tile"), (1, "rug")),
    {
        ...
        t.Semantics.Office: ("weighted_choice", (0, "wood_tile"), (1, "rug")),
        t.Semantics.FactoryOffice: ("weighted_choice", (0, "wood_tile"), (1, "rug")),
        t.Semantics.OpenOffice: ("weighted_choice", (0, "wood_tile"), (1, "rug")),
        t.Semantics.Warehouse: "concrete",
    },
    # lambda: ("weighted_choice", (3, "wood_tile"), (3, "advanced_tiles"),(3, "non_wood_tile"), (3, "rug")),
)
